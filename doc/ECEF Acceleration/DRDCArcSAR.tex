...
\begin{significance}
The material presented in this report provides the design and signal-processing framework for a Synthetic Aperture Radar (SAR) that can image with extremely high resolutions over wide areas. 
\end{significance}
