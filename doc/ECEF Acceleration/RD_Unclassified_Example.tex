...
\documentclass[rd,pdfa]{drdc-report}
...
\futuredistribution{Defence departments}{None}
%Public release
%Defence departments
...
% Add the standard clause for use of human subjects.
\animalsubjectsclause
\humansubjectsclause
