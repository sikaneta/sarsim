...
% \begin{figure}
%     \resizebox{\textwidth}{!}{\input{diffGeoNumerical.pgf}}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_28_error.pgf}}  
  \label{fg:29a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_28_errorProjection_45.0.pgf}} 
  \label{fg:29b}
\end{subfigure} 
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_705_error.pgf}}  
  \label{fg:706a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_705_errorProjection_45.0.pgf}}  
  \label{fg:706b}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_1265_error.pgf}}  
  \label{fg:1266a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_676_error.pgf}}  
  \label{fg:677a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_676_errorProjection_45.0.pgf}}  
  \label{fg:677b}
\end{subfigure} 
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_1649_error.pgf}} 
  \label{fg:1650a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{tsx_1649_errorProjection_45.0.pgf}}  
  \label{fg:1650b}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_4590_error.pgf}}  
  \label{fg:4591a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_4590_errorProjection_45.0.pgf}}  
  \label{fg:4591b}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_1726_error.pgf}}  
  \label{fg:1727a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_1726_errorProjection_45.0.pgf}}  
  \label{fg:1727b}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_4417_error.pgf}}  
  \label{fg:4418a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_4417_errorProjection_45.0.pgf}}  
  \label{fg:4418b}
\end{subfigure}
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_5649_error.pgf}}  
  \label{fg:5650a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
...
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_3724_error.pgf}}  
  \label{fg:3725a}
\end{subfigure}
\begin{subfigure}{.5\textwidth}
  \centering
  % include first image
  \resizebox{\textwidth}{!}{\input{sentinel_3724_errorProjection_45.0.pgf}}  
  \label{fg:3725b}
\end{subfigure}
