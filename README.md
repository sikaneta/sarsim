...
- Setup the simulation by generating pickle files for objects that take time to compute. 
  ...
  This script also generates a set of commands to run the rest of the simulation.
  These commands can be run separately up to each ---wait--- point on multiple
  CPUs, cores or computers. Commands are written to, in this case, 
  simulation_40cm.commands
