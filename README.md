...
- generate the processing filter with generateMultiChanngelFilter
- multi-channel process the multi-channel data with processMultiChannel
- SAR process the generated signal with sarProcess