...
defaultConfig = u'/home/sikaneta/local/Matlab/Delph2014/burstConfig.xml'
...
def FFT_freq(N, fp, f0):
    freq = np.arange(float(N), dtype='float32')*fp/N
    fidx = (freq/fp>0.5)
